...
def receitas_por_categoria(df_receitas):
    ...
    if len(df_receitas_por_categoria) > 8:
        top5 = df_receitas_por_categoria.iloc[:8]
        outros_valor = df_receitas_por_categoria.iloc[8:]["Valor"].sum()
...
def despesas_por_categoria(df_despesas):
    ...
    if len(df_despesas_por_categoria)>8:
        top5=df_despesas_por_categoria.iloc[:8]
        outros_valor = df_despesas_por_categoria.iloc[8:]["Valor_Pago/Recebido"].sum()
